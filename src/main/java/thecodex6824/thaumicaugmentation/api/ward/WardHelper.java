...
public final class WardHelper {
    ...
    public static boolean doesEntityHaveSpecialPermission(EntityLivingBase entity) {
        if (entity instanceof EntityPlayer) {
            ...
            User user=api.getUserManager().getUser(entity.getUniqueID());
            boolean has_perm=user.getCachedData().getPermissionData().checkPermission("thaumicaugmentation.ward").asBoolean();
